 ...
 * Each screen (Rules) has its own Konva.Group that can be
...
class App implements ScreenSwitcher {
	...
	private menuController: RulesScreenController;
	...
	constructor(container: string) {
		...
		this.menuController = new RulesScreenController(this);
	...
	switchToScreen(screen: Screen): void {
		...
		switch (screen.type) {
			case "rules":
				...
				console.log("Switching to rules screen");
